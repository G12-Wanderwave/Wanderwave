        ...
        horizontalAlignment = Alignment.Start) {
          Row(
            ...
            FlexibleRectangle(
                ...
                colorRange =
                    ColorRange(
                        startColor = Color.White, endColor = MaterialTheme.colorScheme.primary),
                durationMillis = 1000,
          ...
          Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            FlexibleRectangle(
                rectangleConstraints = mainRectangleConstraints,
                colorRange = ColorRange(startColor = Color.White, endColor = orange),
                durationMillis = 1000,
                easing = LinearOutSlowInEasing)
            Icon(
                painter = painterResource(id = R.drawable.wanderwave_icon),
          ...
          Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            FlexibleRectangle(
                rectangleConstraints = mainRectangleConstraints,
                colorRange = ColorRange(startColor = Color.White, endColor = Color.Red),
                durationMillis = 1000,
                easing = LinearOutSlowInEasing)
            Icon(
                painter = painterResource(id = R.drawable.wanderwave_icon),
