...
class BeaconPlacerTest : TestCase() {
    ...
    fun placeBeaconRandomly_doesAddBeacons() {
        val location = LatLng(46.519962, 6.633597)
        val nbrMissing = 9
        val beacons = List(BEACON_COUNT-nbrMissing) { Beacon("beacon$it", Location(46.519962, 6.633597)) }
...
fun computeDistanceBetweenBeacons_returnsCorrectDistance() {
    ...
    val newBeacons = mutableListOf(
        Beacon("beacon3", Location(46.521962, 6.635597))
    )
