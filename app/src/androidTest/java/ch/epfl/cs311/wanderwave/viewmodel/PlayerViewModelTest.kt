...
class PlayerViewModelTest {
  ...
  //    viewModel.toggleLoop()
  //    viewModel.selectTrack(viewModel.uiState.value.tracks[viewModel.uiState.value.tracks.size -
  // 1])
  //    viewModel.skipForward()
  //    Assert.assertEquals(viewModel.uiState.value.tracks[0],
  ...
  //    Assert.assertEquals(expectedListItem, result.first().get(0)) // Check if the first item is
  // as expected
  //  }
}
